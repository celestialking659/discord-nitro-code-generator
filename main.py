...
class NitroGen: # Initialise the class
    ...
    def main(self): # The main function contains the most important code
        ...
        if os.name == "nt": # If the system is windows
            print("")
            ctypes.windll.kernel32.SetConsoleTitleA("Nitro Generator and Checker - Made by some guy#3637") # Change the
        else: # Or if it is unix
            print(f'\33]0;Nitro Generator and Checker - Made by some guy#3637\a', end='', flush=True) # Update title of command prompt
...
╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝╚═╝  ╚═╝
        ...
        for i in range(num): # Loop over the amount of codes to check
            ...
            if os.name == "nt": # If the system is windows
                ctypes.windll.kernel32.SetConsoleTitleA(f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by some guy#3637") # Change the title
                print("")
            else: # If it is a unix system
                print(f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by some guy#3637\a', end='', flush=True) # Change the title
